...
<div class="page-content">
    ...
    @php
        $job_status = App\Models\JobStatus::where('job_id','11')->first();
    @endphp
                            ...
                            <h4 class="card-title mb-4 main_lable_color">Set Priority with Number</h4>
                                <div  class="outer">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-md-1">
                                                    <input type="number" class="inner form-control" name="location" placeholder="Enter No" value="{{$job_status->location}}"/>
                                            </div>
                                        
                                            <label class="col-md-2 col-form-label priority_lable_color ">Less Job Assign Providers</label>
                                            <div class="col-md-1">
                                                    <input type="number" class="inner form-control" name="less_assign" placeholder="Enter No" value="{{$job_status->less_assign}}"/>
                                            </div>

                                            <label class="col-md-2 col-form-label priority_lable_color ">Last Job Assigned Providers</label>
                                            <div class="col-md-1">
                                                    <input type="number" class="inner form-control" name="last_assign" placeholder="Enter No" value="{{$job_status->last_assign}}"/>
                                            </div>

                                            <label class="col-md-2 col-form-label priority_lable_color">Maximum Rating</label>
                                            <div class="col-md-1">
                                                    <input type="number" class="inner form-control" name="maximum rating" placeholder="Enter No" value="{{$job_status->maximum_rating}}"/>
                                            </div>
                                        </div> 

                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body pt-0"> 
                                <div>
                                    <a href="{{ route('servicegiver.login') }}">
                                ...
                                <div class="p-2">
                                    <form class="form-horizontal" action="{{ route('servicegiver.check') }}" method="post" autocomplete="off">
                        ...
                        <div class="mt-5 text-center">
                            <p>Don't have an account ? <a href="{{ route('servicegiver.register') }}" class="font-weight-medium text-primary"> Signup now </a> </p>
                        </div>
                    </div>
                </div>
            </div>

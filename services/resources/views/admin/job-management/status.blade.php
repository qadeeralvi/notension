                                ...
                                <div  class="outer">
                                    <div data-repeater-item class="outer">
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-md-2">
                                                    <input type="date" class="inner form-control" name="end_date" value="{{$job_status->end_date}}" placeholder="Enter end date"/>
                                            </div>
                                            <label class="col-md-1 col-form-label priority_lable_color">End time</label>
                                            <div class="col-md-2">
                                                    <input type="time" class="inner form-control" name="end_time" placeholder="Enter end date" value="{{$job_status->end_time}}"/>
                                            </div>
                                ...
                                <div  class="outer">
                                    <div data-repeater-item class="outer">
                                        ...
                                        <div class="form-group row mb-4">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" class="inner form-control" name="minimum" placeholder="Mimimum ..." value="{{$job_status->minimum}}">
                                                </div>
                                                <label class="col-md-1 col-form-label priority_lable_color">Maximum</label>
                                                <div class="col-md-2">
                                                    <input type="number" class="inner form-control" name="maximum" placeholder="Maximum..." value="{{$job_status->maximum}}" />
                                                </div>
                                        </div>
                                        <div class="form-group row mb-4">
                            ...
                            <h4 class="card-title mb-4 main_lable_color">Set Priority with Number</h4>
                                <div  class="outer">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-md-1">
                                                <input type="checkbox" class="inner form-control" name="location" {{($job_status->location!='')?'checked':''}}>
                                            </div>
                                        
                                            <label class="col-md-2 col-form-label priority_lable_color ">Less Job Assign Providers</label>
                                            <div class="col-md-1">
                                                <input type="checkbox" class="inner form-control" name="less_assign" {{($job_status->less_assign!='')?'checked':''}}>
                                            </div>

                                            <label class="col-md-2 col-form-label priority_lable_color ">Last Job Assigned Providers</label>
                                            <div class="col-md-1">
                                                <input type="checkbox" class="inner form-control" name="last_assign" {{($job_status->last_assign!='')?'checked':''}}>
                                            </div>

                                            <label class="col-md-2 col-form-label priority_lable_color">Maximum Rating</label>
                                            <div class="col-md-1">
                                                <input type="checkbox" class="inner form-control" name="maximum_rating" {{($job_status->maximum_rating!='')?'checked':''}}>
                                            </div>
                                        </div> 

				...
				<div class="row gutter-50">
					<div class="col-lg-8">
						<div class="terms-content">
							<div class="content">
								<h3>Notension Privacy Policy</h3>
							...
							<div class="content">
								<h3>Retention and access to data</h3>
						...
						<div class="terms-sidebar mt-60 mt-lg-0">
							<div class="widget widget_search">
								<form action="#" class="search-form style--two">
									<div class="input-wrapper position-relative"><input type="text" class="form-control" placeholder="Enter Your Keyword" name="s" required> <button class="input-icon"><img :src="this.$main + 'assets/img/icon/search-c1.svg'" alt="" class="svg"></button></div>
								</form>
							</div>
							...
							<div class="testimonial-slider3 swiper-container">
								<div class="swiper-wrapper">
									...
									<div class="swiper-slide">
										...
										<div class="rating"><img :src="this.$main + 'assets/img/icon/star-fill.svg'" alt="" class="svg"> <img :src="this.$main + 'assets/img/icon/star-fill.svg'" alt="" class="svg"> <img :src="this.$main + 'assets/img/icon/star-fill.svg'" alt="" class="svg"> <img :src="this.$main + 'assets/img/icon/star-fill.svg'" alt="" class="svg"> <img :src="this.$main + 'assets/img/icon/star-empty.svg'" alt="" class="svg"></div>
										<p>New door Install service Notensions space dedicate content over the each other when sensor indicate problemthey’re door service.</p>
									</div>
								</div>

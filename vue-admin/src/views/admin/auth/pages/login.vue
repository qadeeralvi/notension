                                    ...
                                    <div class="bg-soft-primary">
                                        <div class="row">
                                            ...
                                            <div class="col-5 align-self-end">
                                                <img :src="`${this.$main}/assets/images/profile-img.png`" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <router-link to="/login">
                                                <div class="avatar-md profile-user-wid mb-4">
                                                    <span class="avatar-title rounded-circle bg-light">
                                                        <img :src="`${this.$main}/assets/images/logo.svg`" alt="" class="rounded-circle" height="34">
                                                    </span>
                                                </div>
                                            </router-link>
                                        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
                   async login() {
                          const data =  await this.api('POST',this.$authentication+'adminLogin',this.form,true,true)
                          if(data.status===200){
